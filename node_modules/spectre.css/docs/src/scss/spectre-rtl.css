...
.btn {
  ...
  .btn.btn-warning {
    ...
    .btn.btn-warning:focus {
      box-shadow: 0 0 0 0.1rem rgba(255, 183, 0, 0.2); }
  ...
  .btn.btn-code {
    ...
    color: #fff; }
    .btn.btn-code:focus {
      box-shadow: 0 0 0 0.1rem rgba(215, 62, 72, 0.2); }
    .btn.btn-code:focus, .btn.btn-code:hover {
      background: #d53640;
      border-color: #d02b36;
      color: #fff; }
    .btn.btn-code:active, .btn.btn-code.active {
      background: #c82934;
      border-color: #bb2730;
      color: #fff; }
    .btn.btn-code.loading::after {
      border-bottom-color: #fff;
      border-left-color: #fff; }
  .btn.btn-link {
...
/*# sourceMappingURL=spectre-rtl.css.map */
